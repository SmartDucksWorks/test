...
interface SectionTitleProps { eyebrow?: React.ReactNode; title: React.ReactNode; subtitle?: React.ReactNode }
interface FeatureCardProps { title: React.ReactNode; children?: React.ReactNode }
interface TeamCardProps { name: string; role?: string; blurb?: string; href?: string; imgSrc?: string; imgAlt?: string }
interface CTAButtonProps { href?: string; children?: React.ReactNode }

// ===============================
// Slideshow (FaZt Batts right-column)
// ===============================
...
function Slideshow() {
  ...
  useEffect(() => {
    const id = setInterval(() => setIndex((i) => (i + 1) % slideshowImages.length), 5000);
  ...
  return (
    <img
      ...
      className="h-full w-auto rounded-2xl object-contain transition-opacity duration-700"
    />
  );
}
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-gray-900">
        ...
        <Container className="py-16 sm:py-24">
          <div className="grid lg:grid-cols-2 gap-10 items-stretch max-w-6xl mx-auto">
            ...
            <div className="text-center lg:text-left self-center">
              ...
              <img src="https://github.com/SmartDucksWorks/test/blob/main/FaZtBatts2_green.png?raw=true" alt="Fazt Batts Logo" className="h-48 sm:h-64 w-auto my-6 mx-auto lg:mx-0" />
              <p className="-mt-2 text-2xl font-semibold">The Safest, Fastest and Smartest E-bike batteries on Earth.</p>
              <p className="mt-4 text-lg text-gray-600 max-w-xl">The Cycling Batteries Corporation is pioneering the E-bike battery revolution by creating the most efficient, convenient, universally compatible, and safe e-bike batteries to serve 300+ million global e-bike users.</p>
            ...
            {/* Right: Product slideshow fills column height */}
      ...
      <section id="products" className="py-20">
        <Container>
          ...
          <div className="mt-12">
            <img src="https://github.com/SmartDucksWorks/test/blob/main/COMBO.PNG?raw=true" alt="The Combo Product" className="w-full rounded-2xl shadow" />
          </div>
        </Container>
      </section>
      ...
      <section id="technology" className="py-20 bg-white">
        <Container>
          ...
          <div className="mt-16 rounded-2xl overflow-hidden shadow-lg border">
            <div className="aspect-[9/16] bg-gray-100 flex items-center justify-center text-gray-600">
              Video placeholder — add /public/media/tech.mp4 for production.
            </div>
          </div>
        </Container>
      </section>
