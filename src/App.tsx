  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 text-gray-900">
      ...
      <section id="products" className="py-20">
        <Container>
          <SectionTitle eyebrow="Products" title="The Combo" subtitle="The COMBO includes our FaZt Batts battery and the FaZt Charger. Snap together, plug into any outlet, and get full power in 12 minutes or less." />
